...
setup_logging(f"stdout_{nParticles}_{resolution}_{comm_size}_QH3.txt")
...
Bcs = np.load('multieq_pitchinvs_QH.npy') # from DESC, := (equil,numBc)
...
np.save('dRhoPerEquilData3/drhosQH_uniformed',drho,allow_pickle=True)
np.save('dRhoPerEquilData3/equilibria_inorderQH_uniformed',boozmn_filenames,allow_pickle=True)
