...
setup_logging(f"stdout_{nParticles}_{resolution}_{comm_size}_QA3.txt")
...
Bcs = np.load('multieq_pitchinvs_QA.npy') # from DESC, := (equil,numBc)
...
np.save('dRhoPerEquilData3/drhosQA_uniformed',drho,allow_pickle=True)
np.save('dRhoPerEquilData3/equilibria_inorderQA_uniformed',boozmn_filenames,allow_pickle=True)
